# Project Governance & Documentation Workflow

This document defines the core governance rules and documentation workflow for the Sprout project.
...
`docs/` is the source of truth for project facts.
