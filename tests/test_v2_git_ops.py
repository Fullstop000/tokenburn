"""Tests for llm247_v2.git_ops — Git workflow (worktree isolation, branch, commit, push)."""
...
from llm247_v2.git_ops import GitWorkflow, GitOperationError
...
class TestGitWorkflow(unittest.TestCase):
    ...
    @patch("llm247_v2.git_ops.subprocess.run")
